      ...
      {registeringRequests &&
        registeringRequests.map((request) => (
          <div key={request.id} className="requestItem">
            <h3>{request.user_id.firstName}</h3>
            <h3>{request.user_id.lastName}</h3>
            <h3>{request.user_id.companyName}</h3>
            <h3>{request.user_id.companyAdress}</h3>
            <p>{request.user_id.email}</p>
            <p>{request.user_id.job}</p>
            <p>
